import { u as useAppConfig, r as resolveIconName } from './index-0251dd53.mjs'
...
const _sfc_main = /* @__PURE__ */ defineComponent({
	...
	async setup(__props) {
		...
		watch(
			() => {
				var _a
				return (_a = appConfig.nuxtIcon) == null
					? void 0
					: _a.iconifyApiOptions
			},
			() => {
				var _a, _b, _c, _d, _e, _f
				if (
					!((_b =
						(_a = appConfig.nuxtIcon) == null
							? void 0
							: _a.iconifyApiOptions) == null
						? void 0
						: _b.url)
				)
					return
				...
				if (
					(_d =
						(_c = appConfig.nuxtIcon) == null
							? void 0
							: _c.iconifyApiOptions) == null
						? void 0
						: _d.publicApiFallback
				) {
					addAPIProvider('custom', {
						resources: [
							(_e = appConfig.nuxtIcon) == null
								? void 0
								: _e.iconifyApiOptions.url,
						],
						index: 0,
					})
					return
				...
				addAPIProvider('', {
					resources: [
						(_f = appConfig.nuxtIcon) == null
							? void 0
							: _f.iconifyApiOptions.url,
					],
				})
			},
			{ immediate: true },
		...
		const iconKey = computed(() =>
			[
				resolvedIcon.value.provider,
				resolvedIcon.value.prefix,
				resolvedIcon.value.name,
			]
				.filter(Boolean)
				.join(':'),
		)
		...
		const sSize = computed(() => {
			...
			if (
				!props.size &&
				typeof ((_a = appConfig.nuxtIcon) == null
					? void 0
					: _a.size) === 'boolean' &&
		...
		async function loadIconComponent() {
			...
			if (!((_a = state.value) == null ? void 0 : _a[iconKey.value])) {
				...
				state.value[iconKey.value] = await loadIcon(
					resolvedIcon.value,
				).catch(() => void 0)
...
_sfc_main.setup = (props, ctx) => {
	...
	).add('node_modules/nuxt-icon/dist/runtime/Icon.vue')
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0
}
const Icon = /* @__PURE__ */ _export_sfc(_sfc_main, [
	['__scopeId', 'data-v-bd832875'],
])

export { Icon as default }
//# sourceMappingURL=Icon-12f105c4.mjs.map
