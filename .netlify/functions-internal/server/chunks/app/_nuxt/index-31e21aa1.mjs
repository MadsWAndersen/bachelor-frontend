...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))}><div class="container-row"><div class="col-span-full">`);
      ...
      _push(`</div><button class="col-span-full mr-auto ml-auto bg-slate-700 rounded-sm text-white w-12"> Test console Editor data </button><div class="border-2 col-span-full">${ssrInterpolate(unref(Data))}</div><pre>${ssrInterpolate(unref(data))}</pre></div></div>`);
    };
  }
};
