...
import { r as hash } from '../../nitro/netlify.mjs'
import {
	f as fetchDefaults,
	a as asyncDataDefaults,
	b as useNuxtApp,
	c as createError,
} from '../server.mjs'
...
function useAsyncData(...args) {
	...
	options.getCachedData =
		(_c = options.getCachedData) != null ? _c : getDefaultCachedData
	options.lazy = (_d = options.lazy) != null ? _d : false
	options.immediate = (_e = options.immediate) != null ? _e : true
	options.deep = (_f = options.deep) != null ? _f : asyncDataDefaults.deep
	const hasCachedData = () =>
		![null, void 0].includes(options.getCachedData(key))
	if (!nuxt._asyncData[key] || !options.immediate) {
		;(_g = (_a = nuxt.payload._errors)[key]) != null ? _g : (_a[key] = null)
		const _ref = options.deep ? ref : shallowRef
		nuxt._asyncData[key] = {
			data: _ref(
				(_h = options.getCachedData(key)) != null
					? _h
					: options.default(),
			),
		...
		const promise = new Promise((resolve, reject) => {
			...
			.finally(() => {
				...
				if (asyncData.error.value) {
					nuxt.payload._errors[key] = createError(
...
function useRequestFetch() {
	var _a
	return (
		((_a = useRequestEvent()) == null ? void 0 : _a.$fetch) ||
		globalThis.$fetch
	)
}
function useFetch(request, arg1, arg2) {
	...
	const _key =
		...
		hash([
			autoKey,
			((_a = unref(opts.method)) == null ? void 0 : _a.toUpperCase()) ||
				'GET',
			unref(opts.baseURL),
	...
	const _asyncDataOptions = {
		...
		deep,
		watch:
			watch === false ? [] : [_fetchOptions, _request, ...(watch || [])],
	}
	let controller
	const asyncData = useAsyncData(
		...
		() => {
			var _a2
			;(_a2 = controller == null ? void 0 : controller.abort) == null
				? void 0
				: _a2.call(controller)
			controller =
...
//# sourceMappingURL=fetch-d19c2885.mjs.map
