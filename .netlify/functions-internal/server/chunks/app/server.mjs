...
function createNuxtApp(options) {
	...
	const nuxtApp = {
		...
		runWithContext: (fn) =>
			nuxtApp._scope.run(() => callWithNuxt(nuxtApp, fn)),
		isHydrating: false,
		deferHydration() {
...
function useNuxtApp() {
	...
	if (hasInjectionContext()) {
		nuxtAppInstance =
			(_a = getCurrentInstance()) == null
				? void 0
				: _a.appContext.app.$nuxt
	}
...
const navigateTo = (to, options) => {
	...
	const isExternal =
		(options == null ? void 0 : options.external) ||
		hasProtocol(toPath, { acceptRelative: true })
	if (isExternal) {
			...
			async function redirect(response) {
				...
				nuxtApp.ssrContext._renderResponse = {
					statusCode: sanitizeStatusCode(
						(options == null ? void 0 : options.redirectCode) ||
							302,
						302,
					),
...
const isNuxtError = (err) =>
	!!(err && typeof err === 'object' && '__nuxt_error' in err)
...
const _routes = [
	{
		name: 'documentation-parrentSlug-slug',
		path: '/documentation/:parrentSlug()/:slug()',
		meta: {},
		alias: [],
		redirect: void 0,
		component: () =>
			import('./_nuxt/_slug_-527bdb93.mjs').then((m) => m.default || m),
	},
	{
		...
		redirect: void 0,
		component: () =>
			import('./_nuxt/_slug_-7ba28265.mjs').then((m) => m.default || m),
	},
	{
		name: 'documentation',
		path: '/documentation',
		...
		redirect: void 0,
		component: () =>
			import('./_nuxt/index-4d98ab23.mjs').then((m) => m.default || m),
	},
	{
		name: 'form',
		path: '/form',
		...
		redirect: void 0,
		component: () =>
			import('./_nuxt/index-31e21aa1.mjs').then((m) => m.default || m),
	},
	{
		name: 'index',
		path: '/',
		...
		redirect: void 0,
		component: () =>
			import('./_nuxt/index-5100895d.mjs').then((m) => m.default || m),
	},
	{
		name: 'insight',
		path: '/insight',
		...
		redirect: void 0,
		component: () =>
			import('./_nuxt/index-b36b1ab2.mjs').then((m) => m.default || m),
	},
	{
		name: 'login',
		path: '/login',
		...
		redirect: void 0,
		component: () =>
			import('./_nuxt/index-54ce4f63.mjs').then((m) => m.default || m),
	},
	{
		name: 'test',
		path: '/test',
		...
		redirect: void 0,
		component: () =>
			import('./_nuxt/index-f46fe5c0.mjs').then((m) => m.default || m),
	},
]
	...
	const source =
		...
		route.path
			...
			.replace(/:\w+/g, (r) => {
				var _a
				return (
					((_a = route.params[r.slice(1)]) == null
						? void 0
						: _a.toString()) || ''
				)
			})
...
const appPageTransition = { name: 'slide', mode: 'out-in' }
...
const routerOptions0 = {
	scrollBehavior(to, from, savedPosition) {
		...
		const nuxtApp = /* @__PURE__ */ useNuxtApp()
		const behavior =
			((_a = useRouter().options) == null
				? void 0
				: _a.scrollBehaviorType) ?? 'auto'
...
const plugin$1 = /* @__PURE__ */ defineNuxtPlugin({
	...
	async setup(nuxtApp) {
		...
		const routes =
			((_b = routerOptions.routes) == null
				? void 0
				: _b.call(routerOptions, _routes)) ?? _routes
		let startPosition
		...
		router.afterEach((to, from) => {
			...
			if (
				((_b2 =
					(_a2 = to.matched[0]) == null ? void 0 : _a2.components) ==
				null
					? void 0
					: _b2.default) ===
				((_d =
					(_c = from.matched[0]) == null ? void 0 : _c.components) ==
				null
					? void 0
					: _d.default)
			) {
		...
		router.beforeEach(async (to, from) => {
			...
			if (
				nuxtApp.isHydrating &&
				initialLayout &&
				!isReadonly(to.meta.layout)
			) {
				to.meta.layout = initialLayout
			}
			nuxtApp._processingMiddleware = true
			if (
				!((_a2 = nuxtApp.ssrContext) == null
					? void 0
					: _a2.islandContext)
			) {
						...
						typeof entry2 === 'string'
							? nuxtApp._middleware.named[entry2] ||
							  (await ((_b2 = namedMiddleware[entry2]) == null
									? void 0
									: _b2
											.call(namedMiddleware)
											.then((r) => r.default || r)))
							: entry2
					if (!middleware) {
						throw new Error(
							`Unknown route middleware: '${entry2}'.`,
						)
					}
...
const reducers = {
	...
	ShallowReactive: (data) =>
		isReactive(data) && isShallow(data) && toRaw(data),
...
const LazyIcon = defineAsyncComponent(() =>
	import('./_nuxt/Icon-12f105c4.mjs').then((r) => r.default),
)
const LazyIconCss = defineAsyncComponent(() =>
	import('./_nuxt/IconCSS-6287be66.mjs').then((r) => r.default),
)
...
const layouts = {
	default: () =>
		import('./_nuxt/default-0c5099cb.mjs').then((m) => m.default || m),
}
...
const __nuxt_component_0 = defineComponent({
	...
	setup(props, context) {
		...
		const route =
			injectedRoute === useRoute() ? useRoute$1() : injectedRoute
		const layout = computed(
			() => unref(props.name) ?? route.meta.layout ?? 'default',
		)
		const layoutRef = ref()
						...
						},
						{
							default: () =>
								h(
									LayoutProvider,
									{
										layoutProps: mergeProps(context.attrs, {
											ref: layoutRef,
										}),
...
const _sfc_main$1 = {
	...
	setup(__props) {
		...
		const _Error404 = defineAsyncComponent(() =>
			import('./_nuxt/error-404-a63270ba.mjs').then(
				(r) => r.default || r,
			),
		)
		const _Error = defineAsyncComponent(() =>
			import('./_nuxt/error-500-a819537a.mjs').then(
				(r) => r.default || r,
			),
		)
...
_sfc_main$1.setup = (props, ctx) => {
	...
	;(
		ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())
	).add('node_modules/nuxt/dist/app/components/nuxt-error-page.vue')
...
const _sfc_main = {
	...
	__ssrInlineRender: true,
	setup(__props) {
		const IslandRenderer = defineAsyncComponent(() =>
			import('./_nuxt/island-renderer-28e4f834.mjs').then(
				(r) => r.default || r,
			),
		)
		const nuxtApp = /* @__PURE__ */ useNuxtApp()
...
_sfc_main.setup = (props, ctx) => {
	...
	;(
		ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())
	).add('node_modules/nuxt/dist/app/components/nuxt-root.vue')
