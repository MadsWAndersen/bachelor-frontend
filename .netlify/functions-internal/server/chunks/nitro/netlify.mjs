...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"C:\\Users\\madsw\\dev\\umbraco\\.data\\kv"}));
...
const _lazy_pTxSZR = () => import('../handlers/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_pTxSZR, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_pTxSZR, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, handler as A, send as a, setResponseStatus as b, setResponseHeaders as c, useRuntimeConfig as d, eventHandler as e, getQuery as f, getResponseStatus as g, createError$1 as h, getRouteRules as i, joinURL as j, getResponseStatusText as k, hasProtocol as l, isScriptProtocol as m, defu as n, sanitizeStatusCode as o, parseURL as p, createHooks as q, hash as r, setResponseHeader as s, klona as t, useNitroApp as u, defuFn as v, withQuery as w, parseQuery as x, withTrailingSlash as y, withoutTrailingSlash as z };
