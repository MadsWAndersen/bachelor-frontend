	...
	<header class="container pb-10 pt-7">
		<nav class="container-row items-center">
			...
			<div class="lg:col-span-10 flex justify-end gap-8 items-center">
				...
				<div class="relative">
					<profilePicture class="cursor-pointer" :src="image" @click="toggleDropdown()" />
					<div v-if="isDropdownVisible"
						...
						<a class="block px-4 py-2 px-7 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer hover:bg-um-palepink overflow-hidden"
							@click="userData.logout()">Logout</a>
					</div>
				</div>
			</div>
		</nav>
