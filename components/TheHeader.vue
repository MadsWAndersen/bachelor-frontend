<template>
	<header
		...
		<nav class="container-row items-center">
			...
			<div
				class="container pb-10 pt-10 fixed top-0 right-0 h-screen w-full md:w-1/2 bg-um-white shadow-lg transform transition-transform ease-in-out duration-300 flex flex-col items-end gap-5 z-10"
				:class="{
