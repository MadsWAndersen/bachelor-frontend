<template>
	<header class="container py-7 fixed bg-um-white top-0 left-1/2 -translate-x-1/2 shadow-sm w-full z-40">
		<nav class="container-row items-center">
			...
			<div class="container pb-10 pt-10 fixed top-0 right-0 h-screen w-full md:w-1/2 bg-um-white shadow-lg transform transition-transform ease-umbraco-ease duration-300 flex flex-col items-end gap-5 z-40"
				:class="{
			...
			<div class="lg:col-span-10 justify-end gap-8 items-center lg:flex hidden">
				...
				<NuxtLink class="text-um-blue font-bold m-0 hover:underline" to="/submission">
					Submission
				</NuxtLink>
