...
const containerStyling = () => {
	...
	switch (props.style) {
		case 'dark':
			containerColor = 'bg-[url(@/assets/image/Dark_Blue_Corner.png)] bg-cover text-um-white'
			break
		case 'light':
			containerColor = 'bg-[url(@/assets/image/Pink_Corner.png)]  bg-cover text-um-blue '
			break
		default:
