<template>
	<div
		class="overflow-hidden col-span-full bg-cover bg-left rounded-sm py-4 pr-4 pl-5 lg:pl-[33px] relative hover:shadow-md shadow-none duration-150 ease-umbraco-ease">
		<div
