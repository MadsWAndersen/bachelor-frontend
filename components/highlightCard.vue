<template>
	<div
		...
		<div :class="`h-full absolute w-[13px] left-0 top-0 ${highlightedColor}`"></div>
		...
		<div class="flex justify-between items-center cursor-pointer" @click="toggle">
			...
			<Icon v-if="!isOpen" class="text-um-red cursor-pointer" name="fa:angle-down" />
			<Icon v-if="isOpen" class="text-um-red font-bold cursor-pointer" name="fa:angle-up" />
		</div>

		<div v-if="isOpen" class="text-um-black pt-3 lg:pr-[227px] flex flex-col gap-5">
