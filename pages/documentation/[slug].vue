	...
	<div v-if="localStorageContent">
		<div class="">
			<div class="lg:hidden col-span-2 flex justify-start">
				<button class="text-um-blue z-30 py-4 absolute -top-10" @click="toggleSideMenu">
						...
						<div class="container-row">
							<div class="col-span-full mb-10">
								<h1 class="text-4xl text-um-blue mb-5">
									Welcome to the <span class="font-semibold italic">{{ cmsContent.documentationHeadline
									}}</span>
									category
								</h1>
