<template>
	<div v-if="pageData">
		<div class="container-row text-um-blue">
			<div v-if="cmsContent.childrenData._embedded.content" class="col-span-2 fixed">
		...
		.name
		" spanText="prev" :btnStyle="'prev'" class="col-span-6" />
						<docButton :url="cmsContent.childrenData._embedded.content[0]
							._url
							" :title="cmsContent.childrenData._embedded.content[0]
		.name
		" spanText="next" :btnStyle="'next'" class="col-span-6" />
					</div>
				</div>
			</div>
