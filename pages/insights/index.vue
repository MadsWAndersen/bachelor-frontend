<template>
	<div v-if="cmsContent">
		<HeroHeader :headline="cmsContent.name" :heroText="cmsContent.description" :heroBreadCrumbs="cmsContent._url" />
		...
		<div class="container-row">
			<sectionCard v-for="(card, index) in cmsContent.childrenData._embedded
				.content" :key="index" :url="card._url" :headline="card.insightHeadline" :description="card.teaserText"
				:image="card.image[0]._url" :icon="card.icon?.src" :style="'light'">
			</sectionCard>
		</div>
	</div>
</template>
